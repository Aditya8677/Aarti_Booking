...
function App() {
  useEffect(() => {
    // Add Google Fonts for Hindi + Cinzel
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-red-800 to-yellow-600 relative overflow-hidden scroll-smooth">
